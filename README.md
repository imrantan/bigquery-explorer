...
Auto-loads a synthetic sales dataset (40,000 rows: date, location, category,
channel, product_name, quantity, unit_price, revenue) bundled with the app —
no service account or file needed. Useful for trying out filtering, column
visibility, and aggregation immediately. It's the same file generated by
